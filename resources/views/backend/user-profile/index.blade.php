<x-layout.app title="User Profile" activeMenu="user-profile" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="User Profile" :breadcrumbs="[
        ...
        <div class="card">
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    @can('user-profile create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('user-profile.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input 
                                ...
                                name="search" 
                                class="form-control"
                                placeholder="Cari user profile..."
                                value="{{ old('search', request('search')) }}"
                                hx-get="{{ route('user-profile.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#user-profile-table"
                                hx-push-url="true"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari user profile...</span>
                    </div>
                </div>

                <div id="user-profile-table">
                    @include('user-profile.includes.index-table', compact('userProfile'))
                </div>
            </div>
        </div>
    </div>
