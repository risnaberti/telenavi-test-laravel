<x-layouts.app title="Tata Cara Pembayaran BMI" activeMenu="cara-pembayaran">
                    ...
                    <div class="box-body">
                        <div style="width:100%;background-color:white; padding:10px">
                            ...
                            <ol>
                                ...
                                <li>Masukkan nominal pembayaran sesuai dengan total bayar yang tertera (biaya admin Rp 3000 tertera)</li>
                            ...
                            <ol>
                                ...
                                <li>Masukkan nomor Virtual Account: <b>7510 18 {{ $peserta->siswa?->no_va }}</b></li>
                                <li>Periksa informasi pembayaran pastikan VA sudah sesuai dengan informasi (cek info nama dan nama tagihan), kesalahan transfer ke Virtual Account lain bukan tanggung jawab bagian keuangan</li>
                                <li>Masukkan nominal pembayaran sesuai dengan tagihan yang dimiliki ditambah biaya admin Rp 3.000</li>
                                <li>Masukkan PIN mobile banking Anda</li>
                                <li>Konfirmasi pembayaran</li>
                                <li>Simpan struk ATM sebagai bukti pembayaran</li>
                            </ol>
                            ...
                            <ol>
                                ...
                                <li>Masukkan kode bank Muamalat (147) dilanjut dengan 16 digit nomor virtual account: <b>7510 18 {{ $peserta->siswa?->no_va }}</b></li>
                                <li>Masukkan nominal pembayaran sesuai dengan tagihan yang dimiliki ditambah biaya admin Rp 3.000</li>
                                <li>Periksa informasi pada layar konfirmasi, pastikan nama sudah benar, pastikan virtual account sudah sesuai dengan informasi (cek info nama dan nama tagihan), kesalahan transfer ke Virtual Account lain bukan tanggung jawab bagian keuangan</li>
                                <li>Jika nama siswa sudah benar maka lakukan konfirmasi pada data transfer</li>
                                <li>Jika pada layar tertera bukan nama siswa sesuai Virtual Account yang sudah diinput, silakan batalkan transaksi dan hubungi bagian keuangan</li>
                                <li>Simpan struk ATM sebagai bukti pembayaran</li>
                            </ol>
