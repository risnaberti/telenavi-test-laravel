    ...
    <div class="col-md-12">
        <div class="mb-4">
            ...
            <input type="text" name="nama_lengkap"
                class="form-control {{ $errors->has('nama_lengkap') ? 'is-invalid' : '' }}" id="nama_lengkap"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nisn" class="form-control {{ $errors->has('nisn') ? 'is-invalid' : '' }}"
                id="nisn" value="{{ old('nisn', $pendaftaranTryout?->nisn) }}" placeholder="Masukkan Nisn" />
            @error('nisn')
                <small class="invalid-feedback">{{ $message }}</small>
            @enderror
        </div>
        <div class="mb-4">
            <div class="col-md-12">
                ...
                <x-input.daterangepicker name1="tanggal_lahir"
                    value1="{{ old('tanggal_lahir', $pendaftaranTryout?->tanggal_lahir) }}" placeholder="Pilih Tanggal"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_asal_sekolah"
                class="form-control {{ $errors->has('nama_asal_sekolah') ? 'is-invalid' : '' }}" id="nama_asal_sekolah"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_ortu"
                class="form-control {{ $errors->has('nama_ortu') ? 'is-invalid' : '' }}" id="nama_ortu"
                value="{{ old('nama_ortu', $pendaftaranTryout?->nama_ortu) }}" placeholder="Masukkan Nama Ortu" />
            @error('nama_ortu')
                <small class="invalid-feedback">{{ $message }}</small>
            @enderror
        </div>
        <div class="mb-4">
            ...
            <input type="text" name="no_wa_ortu"
                class="form-control {{ $errors->has('no_wa_ortu') ? 'is-invalid' : '' }}" id="no_wa_ortu"
                value="{{ old('no_wa_ortu', $pendaftaranTryout?->no_wa_ortu) }}" placeholder="Masukkan No Wa Ortu" />
            @error('no_wa_ortu')
                <small class="invalid-feedback">{{ $message }}</small>
            @enderror
        </div>
        <div class="mb-4">
            ...
            <input type="text" name="no_wa_peserta"
                class="form-control {{ $errors->has('no_wa_peserta') ? 'is-invalid' : '' }}" id="no_wa_peserta"
